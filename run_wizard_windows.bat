...
if "%MODE%"=="5" set "EXTRA_ARGS=--packages BattlePacket,AnimationPacket,CharacterPerformance --categories effects,animation,materials,textures,prefabs"
if "%MODE%"=="6" set "EXTRA_ARGS="
